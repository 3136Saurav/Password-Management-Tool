package com.epam.lbm.userservice.exception_handler;
...
public class UserExceptionHandler {
	...
	@ExceptionHandler
	@ResponseStatus(code = HttpStatus.BAD_REQUEST)
	public Map<String,String> handleUserDoesNotExist(UserDoesNotExistException ex) {
	...
	@ExceptionHandler
	@ResponseStatus(code = HttpStatus.BAD_REQUEST)
	public Map<String,String> handleNoUsersAvailable(NoUsersAvailableException ex) {
		String message = ex.getMessage();
